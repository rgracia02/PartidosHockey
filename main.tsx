...
// Clean up any Service Worker left registered by older versions of the app.
// Browsers keep an installed Service Worker active (serving cached, possibly
// outdated files) even after it's removed from the source code, which can
// cause a persistent blank screen for returning visitors.
try {
