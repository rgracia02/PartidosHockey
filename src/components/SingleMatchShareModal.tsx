        ...
        <div className="flex-1 overflow-y-auto min-h-0 space-y-4 py-2">
          ...
          <div className="bg-slate-900 text-white rounded-2xl p-4 shadow-sm">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="px-3 py-1 bg-white/10 rounded-xl text-center min-w-[70px] dark:bg-slate-900">
                {match.isCompleted ? (
                  <>
              ...
              <div className="relative rounded-xl overflow-hidden border border-slate-200 bg-black/5 aspect-video flex items-center justify-center group dark:border-slate-700">
                ...
                <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                  <button
                    ...
                    className="p-2 bg-white text-slate-800 rounded-full text-xs font-bold flex items-center gap-1 shadow-md hover:bg-slate-100 dark:bg-slate-900 dark:text-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700"
                  >
