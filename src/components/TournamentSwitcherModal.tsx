...
export function TournamentSwitcherModal({
  ...
  return (
    ...
    >
      <div className="bg-white w-full max-w-lg rounded-t-[32px] sm:rounded-3xl p-5 pb-safe shadow-2xl flex flex-col max-h-[90vh] animate-in slide-in-from-bottom-5 duration-200">
        {/* Modal Header */}
        ...
        {isCreating ? (
          <form onSubmit={handleCreateSubmit} className="py-4 space-y-3.5 overflow-y-auto flex-1">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-600 mb-1">Año / Temporada</label>
                <input
                  type="text"
                  value={newSeason}
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-2xl text-xs font-semibold text-slate-900 min-h-[44px]"
                >
              ...
              <div>
                <label className="block text-xs font-bold text-slate-600 mb-1">Canchas</label>
                <select
            ...
            <div className="flex gap-2 pt-2">
              <button
                ...
                className="flex-1 py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-2xl text-xs min-h-[44px] transition-all"
              >
                Cancelar
              </button>
              <button
          ...
          <div className="flex-1 overflow-hidden flex flex-col pt-3">
            {/* Filter Tabs */}
            <div className="bg-slate-100/90 p-1 rounded-2xl flex items-center gap-1 mb-3">
              <button
                    ...
                    >
                      <div className="min-w-0 flex-1 pr-3">
                        <div className="flex items-center gap-1.5 mb-1">
                          ...
                          {status === 'completed' && (
                            <span className="px-2 py-0.5 rounded-md bg-slate-200 text-slate-800 font-black text-[10px] flex items-center gap-1">
                              🏁 Finalizado
                            </span>
                          )}
                          {status === 'upcoming' && (
                            <span className="px-2 py-0.5 rounded-md bg-amber-100 text-amber-800 font-black text-[10px] flex items-center gap-1">
                              ⏳ Próximo
                            </span>
                          )}
            ...
            <div className="pt-3 border-t border-slate-100 mt-2">
              <button
                ...
                className="w-full py-3.5 bg-slate-900 active:bg-black text-white font-bold rounded-2xl text-xs flex items-center justify-center gap-2 shadow-sm active:scale-95 transition-all min-h-[46px]"
              >
